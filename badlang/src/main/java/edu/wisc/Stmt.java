...
abstract class Stmt {
  ...
  static class Function extends Stmt {
    final String name; final VarType returnType; final List<Parameter> params; final List<Stmt> body;
    Function(String name, VarType returnType, List<Parameter> params, List<Stmt> body) { this.name = name; this.returnType = returnType; this.params = params; this.body = body; }
  ...
  static class Var extends Stmt {
    final String name; final VarType type; final Expr initializer;
    Var(String name, VarType type, Expr initializer) { this.name = name; this.type = type; this.initializer = initializer; }
  ...
  static class Assign extends Stmt {
    ...
    @Override <R> R accept(Visitor<R> visitor) { return visitor.visitAssignStmt(this); }
  }
